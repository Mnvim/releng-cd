...
ZS="3G"                                                                                                                                        # dimensione swap zram - size swap zram
...
su - $user -c "git clone https://aur.archlinux.org/paru.git /home/$user/paru"
su - $user -c "cd /home/$user/paru && makepkg -si --noconfirm && cd .."

# Descargar e instalar gnome-tweaks, extension-manager y papirus-icon-theme con paru
#su - $user -c "paru -S gnome-tweaks extension-manager papirus-icon-theme --noconfirm && cd .."

# Clonar paquetes desde GitHub
#su - $user -c "git clone https://github.com/ArchItalia/core-gnome-backgrounds.git /home/$user/core-gnome-backgrounds"

# Construir e instalar los paquetes
#su - $user -c "cd /home/$user/core-gnome-backgrounds && makepkg -si --noconfirm && cd .."
